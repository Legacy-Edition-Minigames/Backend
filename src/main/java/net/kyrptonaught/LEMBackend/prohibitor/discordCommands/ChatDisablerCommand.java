...
public class ChatDisablerCommand {
    public static String ID = "prohibitor_chatdisabler:";
    ...
    public static void modalSubmit(ModalInteractionEvent event) {
        ...
        obj.addProperty("type", "chat_disabler");
    ...
    private static Modal buildSelectModal(String server) {
        ...
        return Modal.create(ID + "_submit", "Chat Disabler").addComponents(container).build();
    }
}