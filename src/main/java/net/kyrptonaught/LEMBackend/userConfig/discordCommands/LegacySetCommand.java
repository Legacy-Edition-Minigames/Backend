...
public class LegacySetCommand {
    public static String ID = "userconfiglegacy_set:";
    ...
    public static Modal buildModal(String type, String id) {
        ...
        return Modal.create(ID + type + "_submit", "Set a Player's Configs (Legacy)").addComponents(container).build();
    }
    ...
    public static void modalSubmit(ModalInteractionEvent event) {
        ...
        event.getHook().sendMessageComponents(LegacyViewCommand.viewPlayer(name, uuid)).useComponentsV2().queue();
    }
}
