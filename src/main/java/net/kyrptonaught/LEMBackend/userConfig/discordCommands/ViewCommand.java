...
public class ViewCommand {
    public static String ID = "userconfig_view:";
    ...
    public static Modal buildModal(String type, String id) {
        ...
        return Modal.create(ID + type + "_submit", "View a Player's Configs").addComponents(container).build();
    }
    ...
    public static Container viewPlayer(String name, String uuid) {
        ...
        container.add(Section.of(Button.secondary("refresh", Emoji.fromUnicode("⌚")), TextDisplay.of("## *" + name + "*'s UserConfig")));
